...
public class TestcaseHeading extends TestcaseElementWriterBase implements TestcaseElementWriter {
    @Override
    public int writeExcel() {
        String element = ExcelForms.getMessage(ExcelKey.OBJECT_HEADING);
