...
public class TestcaseWeek extends TestcaseElementWriterBase implements TestcaseElementWriter {
    ...
    private void writeTestcase(String elementName) {
        writeInputValue(ActionType.INPUT_WEEK, elementName);
        writeClearValue(ActionType.CLEAR_WEEK, elementName);
        writeAssertValue(ActionType.ASSERT_WEEK, elementName);
