...
public class TestcaseInputResetButton extends TestcaseElementWriterBase implements TestcaseElementWriter {
    @Override
    ...
    private void writeTestcase(String elementName) {
        writeClick(ActionType.CLICK_INPUT_RESET_BUTTON, elementName);
